...
| 0023 | [Merge K Sorted Lists](https://leetcode.com/problems/Merge-K-Sorted-Lists/) | [Java(Bruteforce)](0023-Merge-K-Sorted-Lists/Solution_BruteForce.java), [Java(Divideandconquer)](0023-Merge-K-Sorted-Lists/Solution_DivideAndConquer.java), [Java(Priorityqueue)](0023-Merge-K-Sorted-Lists/Solution_PriorityQueue.java), [Java(Sequentialmerge)](0023-Merge-K-Sorted-Lists/Solution_SequentialMerge.java) | Hard | 暴力法​​直接收集排序，简单但低效；​​顺序合并法​​通过两两合并简化问题，易于理解；​​分治法​​应用归并思想，达到O(N log k)最优时间复杂度，稳定可靠；​​优先队列法​​利用最小堆动态获取最小值，代码简洁，面试首选。 |